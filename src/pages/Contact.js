...
const Contact = () => {
    ...
    return (
        <div className='mx-auto bg-black bg-cover h-'
            ...
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto backdrop-blur-md">
                        ...
                        <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 dark:border-gray-700">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mt-3 text-center">
                                    <p className="text-sm text-[#013147c9] font-[SanAntycs]">
                        ...
                        <div className="divide-y divide-gray-200 dark:divide-gray-800 font-[SanAntycs]">
                            ...
                            <div className="flex gap-x-7 py-6">
                                ...
                                <div className="grow">
                                    ...
                                    <p className="mt-1 text-sm text-[#013147c9]">We're here to help with any questions or code.</p>
                                    <Link to='/contact' className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-[#013147c9]  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                        Contact support
                            ...
                            <div className="flex gap-x-7 py-6">
                                ...
                                <div className="grow">
                                    ...
                                    <p className="mt-1 text-sm text-[#013147c9]">Search our FAQ for answers to anything you might ask.</p>
                                    <a className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-[#013147c9]  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                                        Visit FAQ
                                        <svg className="flex-shrink-0 size-2.5 transition ease-in-out group-hover:translate-x-1" width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M0.975821 6.92249C0.43689 6.92249 -3.50468e-07 7.34222 -3.27835e-07 7.85999C-3.05203e-07 8.37775 0.43689 8.79749 0.975821 8.79749L12.7694 8.79748L7.60447 13.7596C7.22339 14.1257 7.22339 14.7193 7.60447 15.0854C7.98555 15.4515 8.60341 15.4515 8.98449 15.0854L15.6427 8.68862C16.1191 8.23098 16.1191 7.48899 15.6427 7.03134L8.98449 0.634573C8.60341 0.268455 7.98555 0.268456 7.60447 0.634573C7.22339 1.00069 7.22339 1.59428 7.60447 1.9604L12.7694 6.92248L0.975821 6.92249Z" fill="currentColor" />
                                        </svg>
                            ...
                            <div className=" flex gap-x-7 py-6">
                                ...
                                <div className="grow">
                                    ...
                                    <p className="mt-1 text-sm text-[#013147c9]">If you wish to write us an email instead please use</p>
                                    <a href="mailto:nikhil@tirpriyo.ai" className="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-[#013147c9]  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                        nikhil@tirpriyo.ai
                                    </a>
                                </div>
                            </div>
