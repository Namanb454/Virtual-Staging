        ...
        >
            <div className="relative py-[5vh]">
                <div className=" mx-auto px-4 sm:px-6 lg:px-[4vw]">
                    <div className="text-center  mx-auto space-y-[4vh]">
                        ...
                        <div className="mt-[3vh] font-[Modeka] font-[900]">
                            ...
                            <h1 className="block text-[#081d27] text-[8vw] md:text-[5vw] lg:text-[6vw] w-[70%] mx-auto">
                                Transform Real Estate Images with a Single Click.
                            </h1>
                        </div>
                        {/* End Title */}
                        <div className="font-[Astro] font-bold">
                            <p className="lg:text-[1vw] md:text-[3vw] text-[5vw] text-neutral-950">Save <span className='font-extrabold text-[#]'>90%</span> of the Cost</p>
                        </div>
                        {/* Buttons */}
                        <div className=" flex justify-center font-[Astro] space-x-[2vw] lg:text-[1vw] md:text-[2vw] text-[4vw]">
